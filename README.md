...
|Command|Notes|
|:-|:-|
`dm rumble `| shakes the screen in the area for 500 ms (1/2 second)  If you want to shake the room for longer you can use the `rumble` message/function and send it to the room object like this `send object 7089 rumble duration int 5000`
